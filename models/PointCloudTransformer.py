"""
Point Cloud Transformer code is from https://github.com/Strawberry-Eat-Mango/PCT_Pytorch/
...
from attention_utils.util import sample_and_group
...
class PointCloudTransformer(nn.Module):
    def __init__(self, channel=3, num_class=21, output_channels=3):
        super().__init__()
        self.input_channels = channel + num_class
